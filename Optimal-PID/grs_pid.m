function [Kp_best Ki_best Kd_best]=grs_pid(Kp,Ki,Kd,Gp,Ni,idx)
%
...
[Y T]=myPID(Kp_best,Ki_best,Kd_best,Gp);  % Call PID controller function 
...
for t=1:Ni,
    ...
    [Y T]=myPID(Kp_cand,Ki_cand,Kd_cand,Gp);  % Call PID controller function 
