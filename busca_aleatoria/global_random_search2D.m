...
y_best=round(unifrnd(limites(1),limites(2)));	 % Gera solucao inicial dentro do dominio de Y
...
for t=1:Ng,
    ...
    x_cand(t)=round(unifrnd(limites(1),limites(2)));      % Gera solucao candidata para X
    y_cand(t)=round(unifrnd(limites(1),limites(2)));	% Gera solucao candidata para Y
