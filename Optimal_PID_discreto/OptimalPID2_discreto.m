...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
[Y1 T1]=myPID_discreto(Kp,Ki,Kd);  % Call PID controller function 
...
[Kp_opt Ki_opt Kd_opt]=grs_pid(Kp,Ki,Kd,Ni,idx);

%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%% Compute and plot PID  action AFTER search %%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
[Y2 T2]=myPID_discreto(Kp_opt,Ki_opt,Kd_opt);  % Call PID controller function 
